...
CREATE TABLE IF NOT EXISTS "#__anodos_partner" (
	...
	"category_id" int NOT NULL DEFAULT '1' REFERENCES "#__categories"("id"),
...
INSERT INTO "#__anodos_partner" (
	...
	"competitor")
VALUES
  (DEFAULT, 'undefined', 'undefined', '1', '0', '0', '0', '0');
...
CREATE TABLE IF NOT EXISTS "#__anodos_product" (
	...
	"category_id" int NOT NULL DEFAULT '1' REFERENCES "#__categories"("id"),
	"vendor_id" int8 NOT NULL DEFAULT '1' REFERENCES "#__anodos_partner"("id"),
...
CREATE TABLE IF NOT EXISTS "#__anodos_updater" (
	"id" serial NOT NULL,
	"partner_id" int8 NOT NULL DEFAULT '1' REFERENCES "#__anodos_partner"("id"),
	"category_id" int NOT NULL DEFAULT '1' REFERENCES "#__categories"("id"),
	"name" varchar(255) NOT NULL DEFAULT '',
	"alias" varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO "#__anodos_currency" (
  ...
  "ordering")
VALUES
(DEFAULT, 'Российский рубль', 'RUB', 'р.', '1', '1'),
(DEFAULT, 'Американский доллар', 'USD', '&#36;', '1', '2'),
(DEFAULT, 'Евро', 'EUR', '&#8364;', '1', '3');
