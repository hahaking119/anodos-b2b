...
class AnodosViewProducts extends JViewLegacy {
	...
	public function display($tpl = null) {
		...
		AnodosHelper::addSubmenu('products');
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_ANODOS_PRODUCTS'), 'products.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_anodos&view=products');
