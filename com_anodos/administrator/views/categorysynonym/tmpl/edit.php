...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task == 'categorysynonym.cancel' || document.formvalidator.isValid(document.id('categorysynonym-form'))) {
			Joomla.submitform(task, document.getElementById('categorysynonym-form'));
		}
		else {
...
<form action="<?php echo JRoute::_('index.php?option=com_anodos&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="categorysynonym-form" class="form-validate">
	<div class="row-fluid">
		<!-- Begin Content -->
