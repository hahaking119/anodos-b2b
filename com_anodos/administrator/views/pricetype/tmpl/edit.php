...
$document->addStyleSheet('components/com_anodosprices/assets/css/anodosprices.css');
?>
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		if (task == 'pricetype.cancel' || document.formvalidator.isValid(document.id('pricetype-form'))) {
			Joomla.submitform(task, document.getElementById('pricetype-form'));
		}
		else {
...
<form action="<?php echo JRoute::_('index.php?option=com_anodosprices&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="pricetype-form" class="form-validate">
	<div class="row-fluid">
		<!-- Begin Content -->
			...
			<div class="tab-content">
				<div class="tab-pane active" id="main">
					<fieldset class="adminform">
						...
						<div class="control-group">
							<div class="control-label"><?php echo $this->form->getLabel('fixed'); ?></div>
							<div class="controls"><?php echo $this->form->getInput('fixed'); ?></div>
						</div>
						<div class="control-group">
