...
class AnodosViewCurrencies extends JViewLegacy {
	...
	public function display($tpl = null) {
		...
		AnodosHelper::addSubmenu('currencies');
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_ANODOS_TITLE_CURRENCIES'), 'currencies.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_anodos&view=currencies');
