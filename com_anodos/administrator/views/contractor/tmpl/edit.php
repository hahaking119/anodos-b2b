...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task == 'contractor.cancel' || document.formvalidator.isValid(document.id('contractor-form'))) {
			Joomla.submitform(task, document.getElementById('contractor-form'));
		}
		else {
...
<form action="<?php echo JRoute::_('index.php?option=com_anodos&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="contractor-form" class="form-validate">
	<div class="row-fluid">
		<!-- Begin Content -->
