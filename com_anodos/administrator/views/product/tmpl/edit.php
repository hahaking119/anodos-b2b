...
<form action="<?php echo JRoute::_('index.php?option=com_anodos&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="product-form" class="form-validate">
	<div class="row-fluid">
		<!-- Begin Content -->
		...
		<div class="span2">
			...
			<fieldset class="form-vertical">
				...
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('vat_id'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('vat_id'); ?></div>
				</div>
				<div class="control-group">
					<div class="control-label"><?php echo $this->form->getLabel('duble_of'); ?></div>
					<div class="controls"><?php echo $this->form->getInput('duble_of'); ?></div>
				</div>
			</fieldset>
		</div>
		<!-- End Sidebar -->
