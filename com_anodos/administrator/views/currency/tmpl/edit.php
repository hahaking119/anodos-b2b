...
<form action="<?php echo JRoute::_('index.php?option=com_anodos&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="currency-form" class="form-validate">
	<div class="row-fluid">
		<!-- Begin Content -->
			...
			<div class="tab-content">
				<div class="tab-pane active" id="main">
					<fieldset class="adminform">
						...
						<div class="control-group">
							<div class="control-label"><?php echo $this->form->getLabel('name_html'); ?></div>
							<div class="controls"><?php echo $this->form->getInput('name_html'); ?></div>
						</div>
						<div class="control-group">
