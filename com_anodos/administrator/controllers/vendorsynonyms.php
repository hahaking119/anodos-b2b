...
class AnodosControllerVendorSynonyms extends JControllerAdmin {

	public function getModel($name = 'VendorSynonym', $prefix = 'AnodosModel') {
	...
	public function save() {
		...
		$categories = JRequest::getVar('vendors', array(), 'post');

		// Подключаем модель
		$model = $this->getModel('VendorSynonyms', 'AnodosModel');
