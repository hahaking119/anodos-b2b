...
class UpdaterMerlionMsk {
	...
	$this->addMsg("public function update({$id})");
		...
		$this->addMsg("\$this->updater->id = {$this->updater->id}");
		...
		$this->addMsg("\$this->partner->id = {$this->partner->id}");
		...
		$this->addMsg("\$this->stock['{$alias}']->id = {$this->stock[$alias]->id}");
		...
		$this->addMsg("\$this->priceType['{$alias}']->id = {$this->priceType[$alias]->id}");
		...
		$this->addMsg("\$this->currency['{$alias}']->id = {$this->currency[$alias]->id}");
...
//		$this->addMsg('<p>Message #'.__LINE__." - protected function getData($file).</p>");
...
//		$this->addMsg('<p>Message #'.__LINE__." - protected function toSQL().</p>");
